...
<div class="flex flex-col w-min min-w-[100vw] min-h-screen screen:px-4 screen:py-16">
	...
	<div class="select-none text-center pb-8 print:hidden">
		...
		<Bubble onclick={print} class="cursor-pointer" colors={['black', 'white']}
			>⌘+P → Save as PDF</Bubble
		>
	</div>
	<div
	...
	>
		...
		<div
			class="flex-grow inline-grid grid-cols-[285px_1fr] w-full [&_h2]:font-bold [&_h2]:text-2xl"
		>
			<div class="py-8 pl-12 pr-0 [&>div:not(:first-child)]:pt-8">
				<div class="text-xs">
					...
					<div class="pt-2">
						I've spent 8+ years building APIs, data pipelines, developer platforms, and the
						occassional UI.
					</div>
				...
				<div>
					...
					<div class="flex flex-col mt-2">
						...
						<div class="text-xs pt-1">
							...
							<ul class="[&>li]:pt-1">
								<li>
									Owned immutable, IaC developer platform used by 15+ services teams to deploy 50+
									times a day across 150+ stacks in AWS and GCP
								</li>
								<li>
									Designed and built many APIs, asynchronous processes, and testing tools across all
									product verticals
								</li>
							</ul>
							...
							<ul class="[&>li]:pt-1">
								<li>
									Led cross-team initiative to modernize edge routing and identity infrastructure,
									reducing static asset latency by 40% and API latency by 20%
								</li>
								<li>
									Built internal load testing tool on top of Gatling, used by 3+ service teams to
									benchmark their service under load (UI + service + workers)
								</li>
							</ul>
						</div>
					</div>
